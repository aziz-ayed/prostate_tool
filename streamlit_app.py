...
st.markdown("<h6>Authors: Redacted during review period</h6>", unsafe_allow_html = True)
...
input_dict = {"PSA_t-3": psa_t3, "delta_t-3": delta_t3, "bmi_t-3": bmi_t3,
              ...
              "delta_t": next_psa, "age_diag": age_diag, "Asian": asian, "Black": black,
              "Hispanic": hispanic, "Unknown/other": other, "White": white, "prostate_volume": volume}
